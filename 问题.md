...
- **query设置为高斯分布，加入rotation ：**
  ...
  二值图的“突变边界”问题，模型可以更平滑地感知目标区域。高斯分布不仅告诉模型“目标在哪里”，还提供了“中心更重要、边缘次要”的层次感。高斯分布的概率图在反向传播时提供了更平滑的梯度，而二值图容易导致梯度稀疏。Binary: Hausdorff 距离 0.2967->Gaussian: Hausdorff 距离降低到 0.2887
